When it comes to diagnosing over- and underfitting we have two popular and simple ways of doing this. An example can be seen here: [Hyperparameter Tuning & Overfitting Analysis in Python](Hyperparameter%20Tuning%20&%20Overfitting%20Analysis%20in%20Python.md).
