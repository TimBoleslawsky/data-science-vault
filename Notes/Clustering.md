...
**Is data "clusterable"?**
The general idea is to compare the data distribution with a theoretical distribution with no clustering tendency! This can be done with a [Q-Q Plot](Q-Q%20Plot.md), which is difficult for higher dimensions, or by computing the pairwise distance.
