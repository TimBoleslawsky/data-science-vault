...
Although some task types might today be very specific to [Deep Learning Models](Deep%20Learning%20Models.md), they are in theory model-agnostic. 
...
- Supervised tasks include: [Classification](Classification.md), [Regression](Regression.md), Sequence labeling, etc.
...
- Unsupervised tasks include: [Clustering](Clustering.md), [Topic Modeling](Topic%20Modeling.md), Density Estimation (e.g. used for outlier detection or anomaly detection). 
- Design Patterns used: Clustering algorithms, [Normalization Flows](Deep%20Learning%20Design%20Patterns.md#normalization-flows).
...
- Representation learning tasks includes: [Dimensionality Reduction](Dimensionality%20Reduction.md), [Neural Compression](Neural%20Compression.md), Embedding learning, denoising, etc.
- Design patterns used: [Autoencoders](Deep%20Learning%20Design%20Patterns.md#autoencoders) like [MAEs](Deep%20Learning%20Design%20Patterns.md#masked-autoencoders), [Autoregressive models](Deep%20Learning%20Design%20Patterns.md#autoregressive-models), [Normalization Flows](Deep%20Learning%20Design%20Patterns.md#normalization-flows), [GANs](Deep%20Learning%20Design%20Patterns.md#generative-adversarial-networks-gans), [Diffusion Models](Deep%20Learning%20Design%20Patterns.md#diffusion-models).
...
- Design patterns used: [Variational autoencoders (VAE)](Deep%20Learning%20Design%20Patterns.md#variational-autoencoders), [Autoregressive models](Deep%20Learning%20Design%20Patterns.md#autoregressive-models), [Normalization Flows](Deep%20Learning%20Design%20Patterns.md#normalization-flows), [GANs](Deep%20Learning%20Design%20Patterns.md#generative-adversarial-networks-gans), [Diffusion Models](Deep%20Learning%20Design%20Patterns.md#diffusion-models).
...
- Design patterns used: [Encoder-Decoder models](Deep%20Learning%20Design%20Patterns.md#encoderdecoder-pattern).
