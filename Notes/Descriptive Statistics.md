Descriptive statistics is used to describe a sample. What type of descriptive statistics we can use, is dependent on the [data type](Data.md#data-types). 
...
- [Central tendency measures](Mean%2C%20Median%2C%20%26%20Mode.md), capture the center around which the data is distributed.
- [Variation or variability measures](Variation%20or%20Variability%20Measures.md), describe the data spread, i.e. how far the measurements lie from the center.
...
Sometimes [correlation analysis](Covariance%20%26%20Correlation.md) is also mentioned as descriptive statistic when talking about numerical data. 
## Descriptive Statistics vs. Probability Distribution
Descriptive analysis is limited to the existing sample - it is not designed for describing unseen data (the whole population). For that we need to use [probability distributions](Distribution.md).