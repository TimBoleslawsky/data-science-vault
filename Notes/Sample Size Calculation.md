...
- To achieve a certain power in the test (see here: [Metrics of Hypothesis Tests](Metrics%20of%20Hypothesis%20Tests.md))
- To achieve a certain precision for the CI (see here: [Confidence Intervals](Sampling.md#confidence-intervals))
