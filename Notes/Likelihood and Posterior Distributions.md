...
The difference comes in how this likelihood is use:
	- **Frequentist**: Treats the likelihood as a function to be maximized. The peak is the MLE, a single “best” estimate of θ (see [Maximum Likelihood Estimation (MLE)](Parameter%20Estimation%20for%20Probabilistic%20Models.md#maximum-likelihood-estimation-mle)).
	- **Bayesian**: Uses the likelihood to _update_ the prior into the posterior. Instead of a point estimate, you get an entire distribution over θ (see [Posterior Distribution](Likelihood%20and%20Posterior%20Distributions.md#posterior-distribution)).
...
Getting the posteriori distribution is the main goal of [Parameter Estimation for Probabilistic Models](Parameter%20Estimation%20for%20Probabilistic%20Models.md) in Bayesian statistics.
...
- **Product:** multiplying prior × likelihood is the [conditional probability](Probability.md#conditional-probabilities-on-events) of the parameters, given the assumed probability of the parameters and the probability of the data given the parameters.
...
![Pasted image 20250914134303.png](../Images/Pasted%20image%2020250914134303.png)

Code for this is here: [posterior_predictive_distribution](../Projects/Bayesian%20Statistics/posterior_predictive_distribution.ts).