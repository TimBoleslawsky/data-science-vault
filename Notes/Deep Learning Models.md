...
- **The different design patterns for deep learning models:** Connected to the [[Different Task Types for Mathematical Models]], these design patterns define the _task structure and learning objective_. More here: [[Deep Learning Design Patterns]].
- **The most important paradigms and building blocks in deep learning:** Here we discuss very common paradigms that cut across different deep learning architectures ([[Deep Learning Paradigms and Building Blocks]]).
- **The key architectures of deep learning models:** The building blocks of deep learning models are consolidated in key architecture used across different paradigms ([[Key Architectures in Deep Learning]]).
...
Today it is very common to use transfer learning to take a pre-trained model and only train parts of it to better align it with specific needs. This is done using [[Supervised Fine-Tuning]].
