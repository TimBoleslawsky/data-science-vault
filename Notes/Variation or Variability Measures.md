...
## Variance
**Population Variance**
Is just the equivalent of the variance in probability: $\sigma^2 = \frac{1}{N} \sum_{i=1}^{N} (x_i - \mu)^2$. Be careful that this formula is dependent on the underlying distribution. More about the different formulas for variance depending on the distribution here: [Expected Value & Variance](Expected%20Value%20%26%20Variance.md).
