...
![Pasted image 20250325100633.png](../Images/Pasted%20image%2020250325100633.png)
...
Scaling is common issue in data science ([Data Transformation and Scaling](Data%20Transformation%20and%20Scaling.md)), but when it comes to regression models, we need to specifically look at target scaling. 
...
To combat this problem we can use [Feature Selection](Feature%20Selection.md) and more specifically [Regularization](Regularization.md).
